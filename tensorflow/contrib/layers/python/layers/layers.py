    ...
    with variable_scope.variable_scope(
        ...
        if num_outputs is not None:
            ...
            layer = convolutional_layers.SeparableConvolution2D(
                ...
                strides=stride,
                padding=padding,
                data_format='channels_last' if data_format is 'NHWC' else 'channels_first',
            ...
            kernel_h, kernel_w = utils.two_element_tuple(kernel_size)
            stride_h, stride_w = utils.two_element_tuple(stride)
            num_filters_in = utils.last_dimension(inputs.get_shape(), min_rank=4) if data_format == "NHWC" \
            ...
            outputs = nn.depthwise_conv2d(inputs, depthwise_weights, strides, padding,
                                          rate=utils.two_element_tuple(rate), data_format=data_format)
